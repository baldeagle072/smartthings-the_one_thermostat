...
<script>
	...
	function changeTemp() {
		...
		var url = "https://graph.api.smartthings.com/api/smartapps/installations/<?php print $installedAppId ?>/setTemp/0/";
	...
	function turnOnHeat() {
		...
		var url = "https://graph.api.smartthings.com/api/smartapps/installations/<?php print $installedAppId ?>/setMode/0/heat";
	...
	function turnOnCool() {
		...
		var url = "https://graph.api.smartthings.com/api/smartapps/installations/<?php print $installedAppId ?>/setMode/0/cool";
	...
	function turnOffThermostat() {
		...
		var url = "https://graph.api.smartthings.com/api/smartapps/installations/<?php print $installedAppId ?>/setMode/0/off";
